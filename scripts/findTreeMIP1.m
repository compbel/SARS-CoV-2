function [AM,M_infer] = findTreeMIP1(M,repMut,nonPerfMut,nonPerfSeq)
eps = 0.01;
...
%     idsIntern = (cellstr(num2str([0 nonPerfMut]')))';
%     for j = 1:mRepMut
%         idsIntern{end+1} = [int2str(nonPerfMut(repMut(j))) 'r'];
%     end
%     idsLeafs = (cellstr(num2str((nonPerfSeq)')))';
